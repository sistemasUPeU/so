                                            ...
                                            <ul class="nav nav-tabs" data-tabs="tabs">
                                                ...
                                                <li class="">
                                                    <a href="#messages" data-toggle="tab">
                                                        <i class="material-icons">code</i> Pedidos por Articulo
                                                        <div class="ripple-container"></div>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="#settings" data-toggle="tab">
                                                        <i class="material-icons">cloud</i> Pedidos por Categoria
                                                        <div class="ripple-container"></div>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="#settings" data-toggle="tab">
                                                        <i class="material-icons">cloud</i> Pedidos por Empleado
                                                        <div class="ripple-container"></div>
                                                    </a>
                                                </li>
